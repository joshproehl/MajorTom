...
config :major_tom, MajorTomWeb.Endpoint,
  ...
  http: [ip: {127, 0, 0, 1}, port: 11769],
  check_origin: false,
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "3gG2luktpUycMQ09WIB1neVEsw7gXAaGAgfewtR5rk5WDsJXhlYkQHYOe8o5Zoyj",
  watchers: [
...
config :major_tom, MajorTomWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/major_tom_web/(live|views)/.*(ex)$",
      ~r"lib/major_tom_web/templates/.*(eex)$"
    ]
  ]
